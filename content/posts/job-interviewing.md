...
I outline answers for some of them below.
...
- How do you inspire change in how people work
...
- Micro-yes "Can I give you some feedback?"
- SBI model (situation, behaviour, impact) with solution (SBIS) or alternative (SBIA); be objective and specific: situation, observed action, impact; clear instructions on how to do better
- "[Show, don't tell](https://en.wikipedia.org/wiki/Show,_don%27t_tell)" – show concrete examples
- Find help for person if something bigger to learn
- Check if person understood and received feedback constructively; shift into dialogue, listen, understand and iterate
...
For a system-design interview, follow this structure:

1. Clarify (requirements, constraints)
2. Sketch (high-level architecture, make sure you're on the right track)
...
- Practice live coding as much as you can
- Simulate the interview situation as closely as possible (strict time limit, online editor, etc)

### General approach

1. Clarify (requirements, constraints, priorities)
2. Plan (high-level design, code skeleton, inline comments)
...
- Do you share management slides with the team?
...
After the feedback you will often discuss the interview with your recruiter, in person or in an email.

Some considerations on what to say:
...
Negotiation is part of the process almost always from the very first call.
Here are some negotiation tips, mostly copied from [Ten Rules for Negotiating a Job Offer](https://haseebq.com/my-ten-rules-for-negotiating-a-job-offer/) and [How to Not Bomb Your Offer Negotiation](https://haseebq.com/how-not-to-bomb-your-offer-negotiation/), mixed with my own notes.
...
It's not necessary to have a clear deadline at beginning, but set a clear deadline during intermediary stages.

The deadline should be a business day (e.g. Mon or Fri) so that you can communicate with recruiters.
Proclaim a reason for the deadline (e.g. weekend with family/friends as other decision makers).
...
> Over the last week, I've advanced in the interviews with a few other companies that align more closely with my goals.
>
...
Assert your value: emphasise the unique value you will be bringing to the company; whatever you assert should be something you've touched on earlier in your discussions, but it's okay to repeat it now as a gentle reminder.

> I believe I bring a lot of experience leading a team of developers, and I'm confident that I'll be able to bring [YOUR OFFERINGS] up to parity with your competitors.
...
Depending on your leverage (other offers, BATNA), you have two options to ask for more salary:

Not convincing enough:

> The offer you guys extended was strong.
> Right now my decision is basically between you and [COMPANY].
...
- Equity (https://github.com/jlevy/og-equity-compensation)
- One-off signing or relocation bonus
- Budget for home office (desk, screens, etc)
- Commuter expenses
- Dedicated open-source time
- Dedicated learning time (1 day/month)
...
Here are a few more tips on how to handle recruiters throughout the interviewing process, largely based on [How to sabotage your salary negotiations efforts before you even start](https://interviewing.io/blog/sabotage-salary-negotiation-before-even-start) and [Ten Rules for Negotiating a Job Offer](https://haseebq.com/my-ten-rules-for-negotiating-a-job-offer/).
